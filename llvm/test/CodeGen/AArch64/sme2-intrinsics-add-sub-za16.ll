...
define void @sub_f16_vg1x2(i32 %slice, <vscale x 8 x half> %zn0, <vscale x 8 x half> %zn1) #0 {
...
define void @add_bf16_vg1x2(i32 %slice, <vscale x 8 x bfloat> %zn0, <vscale x 8 x bfloat> %zn1) #0 {
...
; CHECK-NEXT:    ret
                            <vscale x 8 x bfloat> %zn2, <vscale x 8 x bfloat> %zn3) #0 {
...
define void @sub_bf16_vg1x2(i32 %slice, <vscale x 8 x bfloat> %zn0, <vscale x 8 x bfloat> %zn1) #0 {
...
attributes #0 = { nounwind "target-features"="+sme2p1,+bf16,+sme-f16f16,+b16b16" }
